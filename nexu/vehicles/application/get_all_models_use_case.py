...
class GetAllModelsUseCase:
    ...
    def __init__(self, models_repository: ModelsRepository, greater_than_criteria: JSONGreaterThanCriteria, less_than_criteria: JSONLessThanCriteria):
    ...
    def execute(self, greater: str, lower: str):
        return self.models_repository.get_all_models(greater=greater, lower=lower, greater_than_criteria=self.greater_than_criteria, less_than_criteria=self.less_than_criteria)
