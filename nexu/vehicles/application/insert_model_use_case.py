...
from vehicles.application.update_average_price_by_brand_id_use_case import UpdateAveragePriceByBrandIdUseCase
...
class InsertModelUseCase:
    ...
    def execute(self, brand_id: int, name: str, average_price: int):
        ...
        self.models_repository.insert_model(brand_name=brand.name, name=name, average_price=average_price)
        ...
        update_average_price_by_brand_id_use_case = UpdateAveragePriceByBrandIdUseCase(brands_repository=self.brands_repository)
        update_average_price_by_brand_id_use_case.execute(brand_id=brand_id, average_price=current_average_price)
